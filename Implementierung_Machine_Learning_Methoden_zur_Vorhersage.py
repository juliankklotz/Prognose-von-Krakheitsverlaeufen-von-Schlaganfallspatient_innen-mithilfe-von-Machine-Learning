...
ax.set_title('Konfusionsmatrix k-NN bei Min-Max Scaling\n');
ax.set_xlabel('\nVorhergesagte Werte')
...
# %% Decision Tree Grid Search - Zeitaufwändig, deswegen auskommentiert
...
# %% SVM Grid Search - Zeitaufwändig, deswegen auskommentiert
...
ax.set_title('Konfusionsmatrix von k-NN bei Standard Scaling\n');
ax.set_xlabel('\nVorhergesagte Werte')
ax.set_ylabel('Echte Werte');
...
ax.set_title('Konfusionsmatrix von SVM bei Standard Scaling\n');
ax.set_xlabel('\nVorhergesagte Werte')
ax.set_ylabel('Echte Werte');
...
ax.set_title('Konfusionsmatrix von Klassifikationsbaum ohne Skalierung\n');
ax.set_xlabel('\nVorhergesagte Werte')
ax.set_ylabel('Echte Werte');
